...
See `docs/USAGE.md`, `docs/PHASE0_ACCEPTANCE_REPORT.md`, and `docs/PHASE10_COMPLETION_REPORT.md` for the completed Phase 0 workflow and dogfood evidence boundary.
